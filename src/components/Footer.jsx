            ...
            <div className='text-right'>
                <div className='flex w-full justify-end'>
                    <div className='w-full md:w-[300px] py-4 relative'>
                        <div className='flex justify-center md:ustify-end py-4 md:py-0 md:pb-4 mt-[-1rem]'><ThemeToggle/></div>
                        <p className='text-center md:text-right'>Sign Up Crypto News</p>
                        <div className='py-4'>
                            <form>
                                <input className='bg-primary bordr border-input p-2 mr-2 w-full shadow-xl rounded-2xl md:w-auto' type="email" placeholder='Enter your email' />
